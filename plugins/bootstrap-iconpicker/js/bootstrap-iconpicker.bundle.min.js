...
!function($){var data={iconClass:"",iconClassFix:"icon-",icons:[],allVersions:[{version:"1.0.0",icons:["","android-car","android-globe","android-happy","android-sad","block-2","checkmark","clock","close","diamond","diamond-1","direction","flight","glass","globe","globe-1","heart","heart-2","heart-broken","heart-empty","ios-home","ios-home-outline","ios-location","ios-location-outline","ios-rainy","ios-rainy-outline","ios-snowy","ios-star","ios-star-outline","ios-world","ios-world-outline","iphone","location","mobile","moon","moon-1","navigate","paper-plane","paper-plane-1","paper-plane-empty","settings","smile","snowflake-o","social-apple","social-apple-outline","social-facebook","social-facebook-outline","social-twitter","social-twitter-outline","star","star-empty","suitcase","sun","umbrella","umbrella-1","wrench"]}]},l=data.allVersions.length;data.icons=data.allVersions[l-1].icons,$.iconset_cutiesicon=data}(jQuery);
